...
func test_save_load_already_seen() -> void:
    ...
    var global_data_seen_events: Dictionary = save.get_already_seen_history()
...
func test_deletion_save_already_seen() -> void:
    ...
    var global_data_seen_events_after_reset: Dictionary = save.get_already_seen_history()
    ...
    var global_data_seen_events_after_full_reset: Dictionary = save.get_already_seen_history()

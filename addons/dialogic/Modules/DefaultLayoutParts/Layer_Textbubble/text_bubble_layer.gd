...
func bubble_apply_overrides(bubble:TextBubble) -> void:
	...
	if choices_layout_force_lines:
		bubble.add_choice_container(VBoxContainer.new(), choices_layout_alignment, choices_custom_button)
	else:
		bubble.add_choice_container(HFlowContainer.new(), choices_layout_alignment, choices_custom_button)

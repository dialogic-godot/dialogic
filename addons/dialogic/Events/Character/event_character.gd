...
func build_event_editor() -> void:
	...
	add_header_button('', _on_character_edit_pressed, 'Edit character', _editor_node.get_theme_icon("Edit", "EditorIcons"), 'character != null and _character_from_directory != "--All--"')

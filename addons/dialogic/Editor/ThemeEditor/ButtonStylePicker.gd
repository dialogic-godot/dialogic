...
func _ready():
	$"Label".text = DTS.translate("Text Color ")
	$"Label5".text = DTS.translate("Flat background")
	$"BackgroundTextureLabel".text = DTS.translate("Background Texture")
	$"TextureModulationLabel".text = DTS.translate("Texture Modulation")

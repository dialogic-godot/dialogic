...
func load_theme(filename):
	...
	# Background
	n['theme_background_image'].text = DialogicResources.get_filename_from_path(theme.get_value('background', 'image', 'res://addons/dialogic/Images/Example Assets/backgrounds/background-2.png'))
	...
	n['theme_next_image'].text = DialogicResources.get_filename_from_path(theme.get_value('next_indicator', 'image', 'res://addons/dialogic/Images/Example Assets/next-indicator/next-indicator.png'))
	...
	n['button_image'].text = DialogicResources.get_filename_from_path(theme.get_value('buttons', 'image', 'res://addons/dialogic/Images/Example Assets/backgrounds/background-2.png'))
	...
	n['name_image'].text = DialogicResources.get_filename_from_path(theme.get_value('name', 'image', 'res://addons/dialogic/Images/Example Assets/backgrounds/background-2.png'))

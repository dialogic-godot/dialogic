...
func _ready() -> void:
	$"VBoxContainer/TabContainer/Dialog Text/Column/SectionTitle".text = TS.translate("Fonts")
	$"VBoxContainer/TabContainer/Dialog Text/Column/GridContainer/Label5".text = TS.translate("Regular Font")
	$"VBoxContainer/TabContainer/Dialog Text/Column/GridContainer/Label6".text = TS.translate("Bold Font")
	$"VBoxContainer/TabContainer/Dialog Text/Column/GridContainer/Label7".text = TS.translate("Italic Font")
	$"VBoxContainer/TabContainer/Dialog Text/Column2/SectionTitle".text = TS.translate("Colors")
	$"VBoxContainer/TabContainer/Dialog Text/Column2/GridContainer/Label3".text = TS.translate("Text Color")
	$"VBoxContainer/TabContainer/Dialog Text/Column2/GridContainer/Label".text = TS.translate("Shadow")
	$"VBoxContainer/TabContainer/Dialog Text/Column2/GridContainer/Label4".text = TS.translate("Shadow Offset")
	$"VBoxContainer/TabContainer/Dialog Text/Column3/SectionTitle".text = TS.translate("Behaviour")
	$"VBoxContainer/TabContainer/Dialog Text/Column3/GridContainer/Label6".text = TS.translate("Speed (bigger = slower)")
	$"VBoxContainer/TabContainer/Dialog Text/Column3/GridContainer/Label2".text = TS.translate("Alignment")
	$"VBoxContainer/TabContainer/Dialog Text/Column3/GridContainer/Label3".text = TS.translate("Single Portrait Mode")
	$"VBoxContainer/TabContainer/Dialog Box/Column/SectionTitle".text = TS.translate("Visuals")
	$"VBoxContainer/TabContainer/Dialog Box/Column/GridContainer/Label5".text = TS.translate("Background Color")
	$"VBoxContainer/TabContainer/Dialog Box/Column/GridContainer/Label".text = TS.translate("Background Texture")
	$"VBoxContainer/TabContainer/Dialog Box/Column/GridContainer/Label9".text = TS.translate("Texture Modulation")
	$"VBoxContainer/TabContainer/Dialog Box/Column/GridContainer/Label2".text = TS.translate("Full width")
	$"VBoxContainer/TabContainer/Dialog Box/Column/GridContainer/Label6".text = TS.translate("Box padding")
	$"VBoxContainer/TabContainer/Dialog Box/Column/GridContainer/Label7".text = TS.translate("Box size (pixels)")
	$"VBoxContainer/TabContainer/Dialog Box/Column/GridContainer/Label8".text = TS.translate("Bottom gap")
	$"VBoxContainer/TabContainer/Dialog Box/Column2/SectionTitle".text = TS.translate("Next Indicator")
	$"VBoxContainer/TabContainer/Dialog Box/Column2/GridContainer/Label2".text = TS.translate("Image")
	$"VBoxContainer/TabContainer/Dialog Box/Column2/GridContainer/Label4".text = TS.translate("Animation")
	$"VBoxContainer/TabContainer/Dialog Box/Column2/GridContainer/Label3".text = TS.translate("Scale")
	$"VBoxContainer/TabContainer/Dialog Box/Column2/GridContainer/Label9".text = TS.translate("Offset")
	$"VBoxContainer/TabContainer/Dialog Box/Column3/SectionTitle".text = TS.translate("Behaviour")
	$"VBoxContainer/TabContainer/Dialog Box/Column3/GridContainer/Label3".text = TS.translate("Action key")
	$"VBoxContainer/TabContainer/Dialog Box/Column3/GridContainer/Label4".text = TS.translate("Fade in time:")
	$"VBoxContainer/TabContainer/Name Label/Column/SectionTitle".text = TS.translate("Text")
	$"VBoxContainer/TabContainer/Name Label/Column/GridContainer/Label5".text = TS.translate("Name label Font")
	$"VBoxContainer/TabContainer/Name Label/Column/GridContainer/Label".text = TS.translate("Use character Color")
	$"VBoxContainer/TabContainer/Name Label/Column/GridContainer/Label3".text = TS.translate("Shadow")
	$"VBoxContainer/TabContainer/Name Label/Column/GridContainer/Label4".text = TS.translate("Shadow Offset")
	$"VBoxContainer/TabContainer/Name Label/Column2/SectionTitle".text = TS.translate("Box")
	$"VBoxContainer/TabContainer/Name Label/Column2/GridContainer/Label5".text = TS.translate("Background Color")
	$"VBoxContainer/TabContainer/Name Label/Column2/GridContainer/Label2".text = TS.translate("Background Texture")
	$"VBoxContainer/TabContainer/Name Label/Column2/GridContainer/Label9".text = TS.translate("Texture Modulation")
	$"VBoxContainer/TabContainer/Name Label/Column2/GridContainer/Label4".text = TS.translate("Box Padding")
	$"VBoxContainer/TabContainer/Name Label/Column3/SectionTitle".text = TS.translate("Placement")
	$"VBoxContainer/TabContainer/Name Label/Column3/GridContainer/PositionLabel".text = TS.translate("Position")
	$"VBoxContainer/TabContainer/Name Label/Column3/GridContainer/OffsetLabel".text = TS.translate("Offset")
	$"VBoxContainer/TabContainer/Choice Buttons/Column/SectionTitle".text = TS.translate("Button Style")
	$"VBoxContainer/TabContainer/Choice Buttons/Column2/SectionTitle".text = TS.translate("Placement")
	$"VBoxContainer/TabContainer/Choice Buttons/Column2/GridContainer/Label6".text = TS.translate("Box padding")
	$"VBoxContainer/TabContainer/Choice Buttons/Column2/GridContainer/Label".text = TS.translate("Fixed button size")
	$"VBoxContainer/TabContainer/Choice Buttons/Column2/GridContainer/Label2".text = TS.translate("Separation")
	$"VBoxContainer/TabContainer/Choice Buttons/Column2/GridContainer/Label3".text = TS.translate("Layout")
	$"VBoxContainer/TabContainer/Choice Buttons/Column3/SectionTitle".text = TS.translate("Advanced")
	$"VBoxContainer/TabContainer/Choice Buttons/Column3/GridContainer/CustomButtonsLabel".text = TS.translate("Use Custom Buttons")
	$"VBoxContainer/TabContainer/Choice Buttons/Column3/GridContainer/Label2".text = TS.translate("Use Native Buttons")
	$"VBoxContainer/TabContainer/Glossary/Column/SectionTitle".text = TS.translate("Visuals")
	$"VBoxContainer/TabContainer/Glossary/Column/GridContainer/Label3".text = TS.translate("Word color")
	$"VBoxContainer/TabContainer/Glossary/Column/GridContainer/Label4".text = TS.translate("Background Panel")
	$"VBoxContainer/TabContainer/Glossary/Column3/SectionTitle".text = TS.translate("Text")
	$"VBoxContainer/TabContainer/Glossary/Column3/GridContainer/Label5".text = TS.translate("Title Font")
	$"VBoxContainer/TabContainer/Glossary/Column3/GridContainer/Label8".text = TS.translate("Title color")
	$"VBoxContainer/TabContainer/Glossary/Column3/GridContainer/Label6".text = TS.translate("Text Font")
	$"VBoxContainer/TabContainer/Glossary/Column3/GridContainer/Label9".text = TS.translate("Text color")
	$"VBoxContainer/TabContainer/Glossary/Column3/GridContainer/Label7".text = TS.translate("Extra Font")
	$"VBoxContainer/TabContainer/Glossary/Column3/GridContainer/Label10".text = TS.translate("Extra color")
	$"VBoxContainer/TabContainer/Glossary/Column2/SectionTitle".text = TS.translate("Behaviour")
	$"VBoxContainer/TabContainer/Glossary/Column2/GridContainer/Label2".text = TS.translate("Show")
	$"VBoxContainer/TabContainer/Audio/Column/SectionTitle".text = TS.translate("Typing Sound Effects")
	$"VBoxContainer/TabContainer/Audio/Column/GridContainer/Label".text = TS.translate("Enable")
	$"VBoxContainer/TabContainer/Audio/Column/GridContainer/Label2".text = TS.translate("File or folder path")
	$"VBoxContainer/TabContainer/Audio/Column/GridContainer/Label3".text = TS.translate("Volume")
	$"VBoxContainer/TabContainer/Audio/Column/GridContainer/Label4".text = TS.translate("Volume random range")
	$"VBoxContainer/TabContainer/Audio/Column/GridContainer/Label5".text = TS.translate("Pitch random range")

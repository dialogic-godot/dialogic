...
onready var short_cut = $HBox/ShortCutInput
...
func _ready():
	...
	short_cut.connect("text_changed", self, "_on_ShortCut_text_changed")
...
func load_data(data:Dictionary):
	...
	short_cut.text = event_data['shortcut']
...
func _on_ShortCut_text_changed(text):
	event_data['shortcut'] = text

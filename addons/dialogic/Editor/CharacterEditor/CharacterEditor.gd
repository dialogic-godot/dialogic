...
func _ready() -> void:
	...
	$'%PreviewMode'.select(ProjectSettings.get_setting('dialogic/editor/character_preview_mode'))
	_on_PreviewMode_item_selected(ProjectSettings.get_setting('dialogic/editor/character_preview_mode'))

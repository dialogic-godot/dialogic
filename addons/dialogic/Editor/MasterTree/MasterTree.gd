...
func _ready():
	...
	timelines_tree.set_text(0, DialogicTranslator.translate("Timelines", true))
	...
	characters_tree.set_text(0, DialogicTranslator.translate("Characters", true))
	...
	definitions_tree.set_text(0, DialogicTranslator.translate("Definitions", true))
	...
	themes_tree.set_text(0, DialogicTranslator.translate("Themes", true))
	#themes_tree.set_icon(0, get_icon("Folder", "EditorIcons"))
	
	settings_tree = tree.create_item(root)
	settings_tree.set_selectable(0, true)
	settings_tree.set_text(0, DialogicTranslator.translate("Settings", true))
